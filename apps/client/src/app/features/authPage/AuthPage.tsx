...
export const AuthPage = () => {
  ...
  return (
    <div className="bg-gradient text-primary-text grid min-h-dvh grid-cols-1 grid-rows-[auto_auto_1fr] items-center justify-items-center gap-6 px-8 pt-4 text-base sm:grid-cols-2 sm:grid-rows-1 sm:gap-0 sm:p-0">
